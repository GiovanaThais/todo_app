...
class AppModule extends Module {
  ...
  void binds(Injector i) {
    i.addLazySingleton<IOverlayService>(() => AsukaOverLayService(i()),
        config: BindConfig(onDispose: (value) => value.dispose()));

    i.addLazySingleton(() => TaskRepository(i()));
    i.addSingleton<ILocalStorageService>(() => HiveLocalStorageService());
  }
